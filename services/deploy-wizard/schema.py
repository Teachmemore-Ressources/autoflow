...
SECTIONS = [
    ...
    {"id": "redis", "label": "Redis", "desc": "Cache / queue credentials"},
    {
        "id": "awx",
        "label": "AWX",
        "desc": "Automation platform configuration",
    ...
    {"id": "api", "label": "Autoflow API", "desc": "REST API, JWT and rate limiting"},
    {
        "id": "monitoring",
        "label": "Monitoring",
        "desc": "Grafana, Prometheus and alerting",
        "doc_url": f"{DOCS_BASE}/configuration/monitoring/",
    },
    {"id": "minio", "label": "MinIO", "desc": "S3-compatible object storage — Loki log storage backend"},
    {
        "id": "event_engine",
        "label": "Event Engine",
        "desc": "Webhooks, notifications and job routing",
        "doc_url": f"{DOCS_BASE}/configuration/event-engine/",
    },
    {
        "id": "gitea",
        "label": "Gitea",
        "desc": "Self-hosted Git service and registry",
        "doc_url": f"{DOCS_BASE}/configuration/gitea/",
    },
    {
        "id": "pki",
        "label": "PKI",
        "desc": "Internal certificate authority",
...
FIELDS = [
    ...
    },
    {
        ...
        "type": "number",
        "default": "2222",
        "description": "TCP port exposed for Git-over-SSH",
    },
    # ── PostgreSQL ─────────────────────────────────────────────────
    {
        "key": "POSTGRES_DB",
        ...
        "type": "text",
        "default": "awx",
        "description": "AWX PostgreSQL database name",
    },
    {
        "key": "POSTGRES_USER",
        "label": "Username",
        ...
        "type": "text",
        "default": "awx",
        "description": "AWX PostgreSQL username",
    },
    {
    ...
    {
        "key": "AWX_JOB_TEMPLATE_ID",
        "label": "Default Job Template ID",
        "section": "awx",
        "type": "number",
        "default": "1",
    ...
    {
        "key": "MONITORING_ADMIN_PASSWORD",
        "label": "BasicAuth Password",
        "section": "monitoring",
        "type": "password",
        "required": True,
        "auto_generate": True,
        "generate_type": "urlsafe32",
        "description": (
            "Password for Prometheus/Alertmanager BasicAuth — auto-hashed to traefik/dynamic/monitoring_users"
        ),
    },
    {
        "key": "LOKI_RETENTION",
        "label": "Loki Log Retention",
        "section": "monitoring",
        "type": "text",
        "default": "720h",
        "placeholder": "720h",
    ...
    {
        "key": "DEDUP_TTL",
        "label": "Deduplication Window (s)",
        "section": "event_engine",
        "type": "number",
        "default": "60",
    ...
    {
        "key": "JOB_WATCHER_INTERVAL",
        "label": "Job Watcher Interval (s)",
        "section": "event_engine",
        "type": "number",
        "default": "15",
    ...
    },
    {
        ...
        "label": "Local / SFTP Repository Path",
        "section": "backup",
        "type": "text",
        "default": "/var/backups/autoflow/restic",
    ...
    },
    {
        ...
        "label": "S3 Access Key / B2 Account ID",
        "section": "backup",
        "type": "text",
    ...
    },
    {
        ...
        "label": "S3 Secret Key / B2 Application Key",
        "section": "backup",
        "type": "password",
        "sensitive": True,
    ...
    {
        "key": "BACKUP_RTO_HOURS",
        "label": "RTO Target (hours)",
        "section": "backup",
        "type": "number",
        "default": "4",
        "description": (
    ...
    # ── Compliance & Audit ─────────────────────────────────────────
    {
        "key": "COMPLIANCE_ADMIN_TOKEN",
        "label": "Compliance Admin Token",
        "section": "compliance",
        "type": "password",
        "sensitive": True,
        "auto_generate": True,
    ...
    {
        "key": "AWX_METRICS_INTERVAL",
        "label": "AWX Metrics Interval (s)",
        "section": "advanced",
        "type": "number",
        "default": "60",
    ...
    {
        "key": "_ee_heading_config",
        "label": "Configuration",
        "section": "execution_envs",
        "type": "heading",
    },
    {
        "key": "EE_DEFAULT_VERSION",
        "label": "Default Tag",
        "section": "execution_envs",
        "type": "text",
        "default": "latest",
    ...
    {
        "key": "_ee_heading_build",
        "label": "Build local (make ee-build-push)",
        "section": "execution_envs",
        "type": "heading",
    },
    {
        "key": "BUILD_PYCMD",
        "label": "Python build command",
        "section": "execution_envs",
        "type": "text",
    ...
    {
        "key": "_ee_heading_registry",
        "label": "Registry — Gitea Container Registry",
        "section": "execution_envs",
        "type": "heading",
    },
    {
        "key": "_ee_registry_info",
        "label": "",
        "section": "execution_envs",
        "type": "info",
        "description": (
